...
public class ModItemTagsProvider extends ItemTagsProvider 
{
	...
	protected void addTags() 
	{
		...
		copy(ModTags.Blocks.BLOCK_HEXAN_CHISELED_NETHER_BRICKS, ModTags.Items.BLOCK_HEXAN_CHISELED_NETHER_BRICKS);
		copy(Tags.Blocks.STORAGE_BLOCKS, Tags.Items.STORAGE_BLOCKS);
		copy(ModTags.Blocks.BLOCK_GILDED_BRICKS_OF_LOST_TIME, ModTags.Items.BLOCK_GILDED_BRICKS_OF_LOST_TIME);
		copy(Tags.Blocks.STORAGE_BLOCKS, Tags.Items.STORAGE_BLOCKS);
		copy(ModTags.Blocks.BLOCK_RED_GILDED_BRICKS_OF_LOST_TIME, ModTags.Items.BLOCK_RED_GILDED_BRICKS_OF_LOST_TIME);
		copy(Tags.Blocks.STORAGE_BLOCKS, Tags.Items.STORAGE_BLOCKS);
		copy(ModTags.Blocks.BLOCK_HEXAN_CHISELED_POLISHED_BLACKSTONE, ModTags.Items.BLOCK_HEXAN_CHISELED_POLISHED_BLACKSTONE);
		copy(Tags.Blocks.STORAGE_BLOCKS, Tags.Items.STORAGE_BLOCKS);
