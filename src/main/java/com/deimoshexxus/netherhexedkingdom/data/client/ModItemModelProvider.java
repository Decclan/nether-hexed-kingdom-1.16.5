...
public class ModItemModelProvider extends ItemModelProvider {
	...
	protected void registerModels()
	{
		...
		withExistingParent("red_gilded_bricks_of_lost_time_block", modLoc("block/red_gilded_bricks_of_lost_time_block"));
		withExistingParent("hexan_chiseled_polished_blackstone_block", modLoc("block/hexan_chiseled_polished_blackstone_block"));
