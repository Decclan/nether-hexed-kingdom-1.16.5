package com.deimoshexxus.netherhexedkingdom.item.material;
...
public enum ModArmorMaterial implements IArmorMaterial {
   MILITUS_ALLOY("militus_alloy", 15, new int[]{2, 4, 5, 2}, 9, SoundEvents.ARMOR_EQUIP_GENERIC, 0.2F, 0.2F, () -> {
	      return Ingredient.of(ModItems.MILITUS_ALLOY_INGOT.get());
	   });
   ...
   public int getDurabilityForSlot(EquipmentSlotType p_200896_1_) {
	   ...
	   public String getName() {
	      return NetherHexedKingdomMain.MOD_ID + ":" + this.name;
	   }
