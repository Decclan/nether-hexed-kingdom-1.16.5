...
public class TestEntityThree extends AbstractSkeletonEntity
	{
	   ...
	   private final MeleeAttackGoal meleeGoal = new MeleeAttackGoal(this, 1.2D, false) {
	      public void stop() {
	         super.stop();
	         TestEntityThree.this.setAggressive(false);
	      }

	      public void start() {
	         super.start();
	         TestEntityThree.this.setAggressive(true);
	      }
	   };


	public TestEntityThree(EntityType<? extends AbstractSkeletonEntity> type, World worldIn) 
	{
		super(type, worldIn);
