...
public class FaceEaterEntity extends PhantomEntity 
{
	private static final DataParameter<Boolean> DATA_IS_CHARGING = EntityDataManager.defineId(FaceEaterEntity.class, DataSerializers.BOOLEAN);
...
//	private BlockPos anchorPoint = BlockPos.ZERO;
//	private FaceEaterEntity.AttackPhase attackPhase = FaceEaterEntity.AttackPhase.CIRCLE;
	private int explosionPower = 2;

	public FaceEaterEntity(EntityType<? extends PhantomEntity> type, World world) 
	{
		super(type, world);
		this.goalSelector.addGoal(7, new FaceEaterEntity.FireballAttackGoal(this));
   ...
   protected void defineSynchedData() 
   {
	...
	public static AttributeModifierMap.MutableAttribute createAttributes() 
	{
	   ...
	   static class FireballAttackGoal extends Goal {
		      private final FaceEaterEntity faceeater;
		      public int chargeTime;

		      public FireballAttackGoal(FaceEaterEntity p_i45837_1_) {
