...
@OnlyIn(Dist.CLIENT)
public class DeadHorseArmorRenderer extends LayerRenderer<WitherSkeletonHorseEntity, HorseModel<WitherSkeletonHorseEntity>> {
   private final HorseModel<WitherSkeletonHorseEntity> model = new HorseModel<>(0.1F);

   public DeadHorseArmorRenderer(IEntityRenderer<WitherSkeletonHorseEntity, HorseModel<WitherSkeletonHorseEntity>> p_i50937_1_) {
      super(p_i50937_1_);
   }

   public void render(MatrixStack p_225628_1_, IRenderTypeBuffer p_225628_2_, int p_225628_3_, WitherSkeletonHorseEntity p_225628_4_, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
