...
@OnlyIn(Dist.CLIENT)
public class HexedUndeadHorseArmorRenderer extends LayerRenderer<HexedUndeadHorseEntity, HorseModel<HexedUndeadHorseEntity>> {
   private final HorseModel<HexedUndeadHorseEntity> model = new HorseModel<>(0.1F);

   public HexedUndeadHorseArmorRenderer(IEntityRenderer<HexedUndeadHorseEntity, HorseModel<HexedUndeadHorseEntity>> p_i50937_1_) {
      super(p_i50937_1_);
   }

   public void render(MatrixStack p_225628_1_, IRenderTypeBuffer p_225628_2_, int p_225628_3_, HexedUndeadHorseEntity p_225628_4_, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
