...
public class PiglinPrisonerEntity extends AbstractPiglinEntity
{
	protected static final ImmutableList<SensorType<? extends Sensor<? super PiglinPrisonerEntity>>> SENSOR_TYPES = ImmutableList.of(SensorType.NEAREST_LIVING_ENTITIES, SensorType.NEAREST_PLAYERS, SensorType.NEAREST_ITEMS, SensorType.HURT_BY, SensorType.PIGLIN_BRUTE_SPECIFIC_SENSOR);
	...
	public PiglinPrisonerEntity(EntityType<? extends AbstractPiglinEntity> type, World worldIn) 
	{
		super(type, worldIn);
		this.xpReward = 30;
	}
	...
	public static AttributeModifierMap.MutableAttribute createAttributes() 
	{
	   ...
	   public ILivingEntityData finalizeSpawn(IServerWorld p_213386_1_, DifficultyInstance p_213386_2_, SpawnReason p_213386_3_, @Nullable ILivingEntityData p_213386_4_, @Nullable CompoundNBT p_213386_5_) {
	      PiglinPrisonerBrain.initMemories(this);
...
//				this.setItemSlot(EquipmentSlotType.FEET, new ItemStack(Items.GOLDEN_BOOTS));
			...
			this.setItemSlot(EquipmentSlotType.MAINHAND, new ItemStack(null));
	   }
	   ...
	   protected Brain.BrainCodec<PiglinPrisonerEntity> brainProvider() {
		   ...
		   protected Brain<?> makeBrain(Dynamic<?> p_213364_1_) {
		      return PiglinPrisonerBrain.makeBrain(this, this.brainProvider().makeBrain(p_213364_1_));
		   }
		...
		public Brain<PiglinPrisonerEntity> getBrain() {
		   ...
		   protected void customServerAiStep() {
		      ...
		      PiglinPrisonerBrain.updateActivity(this);
		      PiglinPrisonerBrain.maybePlayActivitySound(this);
		   ...
		   public boolean hurt(DamageSource p_70097_1_, float p_70097_2_) {
		      ...
		      if (this.level.isClientSide) {
		         ...
		         if (flag && p_70097_1_.getEntity() instanceof LivingEntity) {
		            PiglinPrisonerBrain.wasHurtBy(this, (LivingEntity)p_70097_1_.getEntity());
		         }
