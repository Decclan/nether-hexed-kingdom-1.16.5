...
public class PiglinBeserkerBrain {
   protected static Brain<?> makeBrain(PiglinBeserkerEntity p_242354_0_, Brain<PiglinBeserkerEntity> p_242354_1_) {
   ...
   protected static void initMemories(PiglinBeserkerEntity p_242352_0_) {
   ...
   private static void initCoreActivity(PiglinBeserkerEntity p_242359_0_, Brain<PiglinBeserkerEntity> p_242359_1_) {
   ...
   private static void initIdleActivity(PiglinBeserkerEntity p_242362_0_, Brain<PiglinBeserkerEntity> p_242362_1_) {
      p_242362_1_.addActivity(Activity.IDLE, 10, ImmutableList.of(new ForgetAttackTargetTask<>(PiglinBeserkerBrain::findNearestValidAttackTarget), createIdleLookBehaviors(), createIdleMovementBehaviors(), new FindInteractionAndLookTargetTask(EntityType.PLAYER, 4)));
   }

   private static void initFightActivity(PiglinBeserkerEntity p_242364_0_, Brain<PiglinBeserkerEntity> p_242364_1_) {
   ...
   private static FirstShuffledTask<PiglinBeserkerEntity> createIdleLookBehaviors() {
   ...
   private static FirstShuffledTask<PiglinBeserkerEntity> createIdleMovementBehaviors() {
   ...
   protected static void updateActivity(PiglinBeserkerEntity p_242358_0_) {
      Brain<PiglinBeserkerEntity> brain = p_242358_0_.getBrain();
   ...
   protected static void wasHurtBy(PiglinBeserkerEntity p_242353_0_, LivingEntity p_242353_1_) {
      if (!(p_242353_1_ instanceof AbstractPiglinEntity)) {
         PiglinPublicTasks.maybeRetaliate(p_242353_0_, p_242353_1_);
      }
   }

   protected static void maybePlayActivitySound(PiglinBeserkerEntity p_242360_0_) {
   ...
   private static void playActivitySound(PiglinBeserkerEntity p_242363_0_) {
